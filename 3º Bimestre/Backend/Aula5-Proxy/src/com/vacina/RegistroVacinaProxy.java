...
public class RegistroVacinaProxy implements IRegistro{
    ...
    // Proxy - Método que controla se a vacina está ocorrendo dentro da data agendada ou posteiror a ela
    @Override
    public void registrar(Object[] dados) {
        if (verificarData((Date)(dados[1]))){
            ...
            System.out.println("Não pode vacinar em data anterior ao agendamento.");
        }
    }

        // Método que veirifica se a data é anterior ou igual
