...
const ViaCEP = () => {
  ...
  const handleSubmit = async ({ cep }) => {
    try {
      ...
      Swal.fire({
        title: 'Ih rapaz!!! A casa caiu!',
        icon: 'error',
        text: 'CEP não encontrado seu trouxa, volta lá e pesquisa.'
      });
    }
  }
        ...
        <div className="col-md-4 col-sm-6 my-3 container text-center">
          ...
          {endereco.cep && (
            <ul className="list-group my-3">
              ...
              <li>{endereco.uf}</li>
              <li><Link to={`/brasilapi/${endereco.cep}`}>Veja o endereço com BrasilAPI</Link></li>
            </ul>
          )}
        </div>
      </main>
